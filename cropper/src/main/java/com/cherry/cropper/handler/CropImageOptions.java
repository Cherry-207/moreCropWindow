...
public class CropImageOptions implements Parcelable {
     ...
     */
    public Enum.CropShape cropShape;
    ...
    /**
     * 当调整剪切框大小时，内部的分割线应该是打开、关闭还是仅显示。
     */
    public Enum.Guidelines guidelines;
   ...
   */
     ...
     * 未被激活的裁剪框的背景颜色
     */
    public int unactivatedRegionColor;
     ...
     */
    public Enum.RequestSizeOptions outputRequestSizeOptions;
    ...
    public CropImageOptions() {
        ...
        cropShape = Enum.CropShape.RECTANGLE;
        ...
        guidelines = Enum.Guidelines.ON_TOUCH;
        scaleType = Enum.ScaleType.FIT_CENTER;
        ...
        borderCornerOffset = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, dm);  //5
        borderCornerLength = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 27, dm);
        ...
        backgroundColor = Color.argb(102, 0, 0, 0);
        unactivatedRegionColor = Color.argb(51, 0, 0, 0);
        ...
        outputRequestSizeOptions = Enum.RequestSizeOptions.NONE;
        noOutputImage = false;
    ...
    protected CropImageOptions(Parcel in) {
        cropShape = Enum.CropShape.values()[in.readInt()];
        snapRadius = in.readFloat();
        touchRadius = in.readFloat();
        guidelines = Enum.Guidelines.values()[in.readInt()];
        scaleType = Enum.ScaleType.values()[in.readInt()];
        ...
        unactivatedRegionColor = in.readInt();
        ...
        outputRequestSizeOptions = Enum.RequestSizeOptions.values()[in.readInt()];
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(unactivatedRegionColor);
