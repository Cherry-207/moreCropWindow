...
public final class CropWindowMoveHandler {
    ...
    /**
     * 根据当前裁剪窗口的高度和给定的长宽比调整左边缘，
     * 右边的边保持不变，而左边的调整，以保持长宽比的高度。
     */
    ...
    /**
     * 根据当前裁剪窗口宽度和给定长宽比调整上下边缘，
     * 顶部和底部边缘相对于中心的调整相同，以保持长宽比的宽度。
     */
